...
char *getConfigPath(void)
{
        ...
        if (xdgConfig)
        {
                snprintf(configPath, MAXPATHLEN, "%s/rpd", xdgConfig);
        }
        else
        {
                ...
                {
#ifdef __APPLE__
                        snprintf(configPath, MAXPATHLEN, "%s/Library/Preferences/rpd", home);
#else
                        snprintf(configPath, MAXPATHLEN, "%s/.config/rpd", home);
#endif
                }
                else
                {
                        ...
                        {
#ifdef __APPLE__
                                snprintf(configPath, MAXPATHLEN, "%s/Library/Preferences/rpd", pw->pw_dir);
#else
                                snprintf(configPath, MAXPATHLEN, "%s/.config/rpd", pw->pw_dir);
#endif
                        }
                        else
                        {
